...
class Server:
    ...
    def get_hyper(self, page: int = 1, page_size: int = 10) -> Dict:
        '''
        Returns a dictionary containg the following key-value pairs.
        '''
        ...
        page_info = {
            ...
            'page': page,
            'data': page_data,
            'next_page': page + 1 if endex < len(self.__dataset) else None,
            'prev_page': page - 1 if staIndex > 0 else None,
